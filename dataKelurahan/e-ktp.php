...
<div class="containerr d-flex flex-column h-100 align-items-center">
  <div class="w-100 border warna_background">
    ...
    <div class="content d-flex flex-column w-75 align-items-center my-3">
      ...
      <h4 class="w-100 my-2">Proyek e-KTP dilatarbelakangi oleh sistem pembuatan KTP konvensional di Indonesia yang memungkinkan seseorang dapat memiliki lebih dari satu KTP. Hal ini disebabkan belum adanya basis data terpadu yang menghimpun data penduduk dari seluruh Indonesia. Fakta tersebut memberi peluang penduduk yang ingin berbuat curang terhadap negara dengan menduplikasi KTP-nya.</div></h4>
      <div class="mt-4 d-flex flex-row">
        <img class="mx-5 mt-5 gambar_pm" src="assets/ektp1.png" alt="masyarakat">
        <div style="width: 100px"></div>
        <img class="mx-5 mt-5 gambar_pm" src="assets/ektp2.png" alt="masyarakat">
      </div>
    </div>
