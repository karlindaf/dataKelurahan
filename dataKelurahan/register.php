    ...
    <div class="content d-flex flex-row w-75  justify-content-between my-5">
      ...
      <div class="border border-primary rounded-5 d-flex flex-column align-items-center justify-content-center w-50">
        <h1 class="fw-bold text-primary">Register</h1>
          <form method="post" action="register_check.php" class="w-75 d-flex flex-column align-items-center">
          ...
          <?php } ?>
           ...
           <div class="d-flex flex-row w-75 justify-content-between my-3">
            <div class="">
              <input type="radio" id="" name="" value="remember">
              <label for="remember">Remember me</label>
            </div>
              <a class ="link" href="index.php">Alredy have an account</a>
           </div>

            <div class="form-group w-75 d-flex justify-content-center my-3">
                <button type="submit" class="btn btn-primary btn-block w-50 "> Register  
                </button>
            </div> 
            </form>
