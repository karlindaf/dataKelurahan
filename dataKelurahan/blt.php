  ...
  <div class="w-100 border warna_background">
    ...
    <div class="content d-flex flex-column w-75 align-items-center my-3">
      <div class="d-flex flex-row w-100">
        <a class="kotak shadow-sm p-2 mb-5 fs-6 rounded m-auto " href="pelayanan.php"><button type="button" class="fw-bold h-100 w-100  btn btn-outline-primary">Pelayanan Masyarakat</button></a>
      ...
      <h4 class="w-100 my-2">Program bantuan dari pemerintah berjenis pemberian uang tunai atau beragam bantuan lainnya, baik bersyarat (conditional cash transfer) maupun tak bersyarat (unconditional cash transfer) untuk masyarakat miskin.
Besaran dana yang diberikan dan mekanisme yang dijalankan dalam program BLT berbeda-beda tergantung kebijakan pemerintah.</h4>
      <div class="mt-4 d-flex flex-row">
        <img class="mx-5 mt-5 gambar_pm" src="assets/info1.png" alt="masyarakat">
        <div style="width: 100px"></div>
        <img class="mx-5 mt-5 gambar_pm" src="assets/info2.jpg" alt="masyarakat">
      </div>
    </div>
